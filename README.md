...
This is a Smart Contract project built along the Foundry Fundamentals course by Cyfrin/Patrick Collins. The Smart Contract, FundMe, located in src/FundMe.sol, allows multiple addresses to fund it and keeps track of all the addresses that have sent money to it. Withdrawals are restricted to the contract owner only. The Smart Contract can run on all EVM-based chains.

You can see and interact with the contract on Etherscan [here](https://sepolia.etherscan.io/address/0x16dc42fd59150f00223ef55476b4f8b51bcb3225). It's already verified, so feel free to test it out!
...
# Thanks, Patrick Collins, for this awesome course!

If you appreciated this repo, feel free to follow or donate to my tutor!
